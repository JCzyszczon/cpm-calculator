...
function LearnMore() {
    ...
    return (
        <section id="learnMore" className='w-full min-h-screen dark:bg-modalColorD bg-modalColorL flex flex-col justify-center items-center md:px-[10%] px-4 py-6 md:gap-28 gap-14 relative'>
