...
function LearnMore() {
  ...
  return (
    <section
      id='learnMore'
      className='w-full md:max-h-screen h-auto dark:bg-backgroundColorD bg-backgroundColorL flex flex-col justify-start items-center md:px-[30%] px-4 md:pt-[6%] md:pb-[4%] p-14 md:gap-20 gap-10 relative overflow-hidden'
    >
      <section className='flex flex-col justify-center items-center md:gap-10 gap-4 text-center md:px-0 px-[4%] z-[1]'>
        <div className='px-6 py-1 dark:bg-modalColorD dark:border-borderColorD bg-modalColorL border border-borderColorL rounded-lg font-bold text-xs dark:text-borderColorL text-borderColorD'>
          FAQ
        </div>
        <motion.h2
          ...
          className='responsive_text font-bold'
        >
          We&apos;re here to <span className='text-themeColorT'>answer</span>{" "}
          all <span className='text-themeColorY'>your</span>{" "}
          <span className='text-themeColorP'>questions.</span>
        </motion.h2>
        <p className='md:text-base text-sm'>
          If you&apos;re new here or looking for information, this section will
          help you learn more about the Critical Path Method and our platform.
        </p>
      </section>
      <section className='flex w-full max-w-[1980px] flex-col justify-start items-center gap-2'>
        <FAQItem
      ...
      <section className='w-full flex flex-col justify-center items-center md:gap-6 gap-4'>
