...
export default function NotFound404() {
    ...
    return (
      <section className='w-screen min-h-screen flex justify-center items-center relative px-10 py-20'>
        <section className='flex flex-col justify-center items-center gap-10 text-center select-none'>
            <p className='responsive_text3 font-extrabold flex justify-center items-center'>4<span><Image src={Astronaut2} alt="Astronaut image" priority className='md:w-[280px] w-[200px] rounded-full'/></span>4</p>
            <h1 className='md:text-5xl text-3xl font-extrabold tracking-tighter'>Something went <span className='text-themeColorP'>wrong</span>.</h1>
